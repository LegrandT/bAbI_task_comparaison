...
class MemN2N(object):
    ...
    def __init__(self, param, sess):
        self.nwords = param['nwords']
        self.max_words = param['max_words']
        self.max_sentences = param['max_sentences']
        self.init_mean = param['init_mean']
        self.init_std = param['init_std']
        self.batch_size = param['batch_size']
        self.nepoch = param['nepoch']
        self.anneal_epoch = param['anneal_epoch']
        self.nhop = param['nhop']
        self.edim = param['embDim']
        self.mem_size = param['mem_size']
        self.max_grad_norm = param['max_grad_norm']
        
        self.lin_start = param['lin_start']
        self.is_test = param['is_test']
        ...
        if self.lin_start:
            ...
            self.current_lr = param['init_lr']

        self.anneal_rate = param['anneal_rate']
        self.loss = None
        self.optim = None
